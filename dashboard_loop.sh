...
dashboard_loop() {
    ...
    while true; do
        ...
        [[ $(curl -s --head --max-time 3 https://google.com >/dev/null 2>&1; echo $?) -eq 0 ]] && internet_status="${BOLDGREEN}🌐 Internet: ONLINE${RESET}" || internet_status="${BOLDRED}📴 Internet: OFFLINE${RESET}"
